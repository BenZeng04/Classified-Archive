class Card
{
  ...
  public void setupNBT() // WIP
  {
    ...
    if(name.equals("Disastrous Experiment")) NBTTags.add("Unobtainable");
    if(name.equals("Joseph") || name.equals("Anny") || name.equals("Tony") || name.equals("Mr. Onosukoo")) NBTTags.add("OverrideBuffer");
